...
redshift.options = "-l 48.6932:6.18279"
...
beautiful.init("/home/belettefurtive/.config/awesome/themes/gnomish/theme.lua")
...
mymainmenu = awful.menu({ items = { { "awesome", myawesomemenu, beautiful.awesome_icon },
							 ...
							 { "lock screen", function() awful.util.spawn("dm-tool lock") end },
							 { "switch user", function() awful.util.spawn("dm-tool switch-to-greeter") end },
...
separator_color = beautiful.separator or "#9EBABA"
widgettext_color = beautiful.widgettext or "#1c365c"
widgetinfo_color = beautiful.widgetinfo or "#CCCCCC"
...
separator:set_markup(' <span color="' .. separator_color .. '">|</span> ')

mem    = clumsy.widget("memory",       widgettext_color, widgetinfo_color)
bat    = clumsy.widget("battery",      widgettext_color, widgetinfo_color)
--bright = clumsy.widget("brightness",   widgettext_color, widgetinfo_color)
nvidia = clumsy.widget("bumblebee",    widgettext_color, widgetinfo_color)
vol    = clumsy.widget("volume",       widgettext_color, widgetinfo_color)
...
--bright:buttons(awful.util.table.join(
--				  awful.button({}, 4, function ()
...
for s = 1, screen.count() do
	...
	right_layout:add(nvidia)
	right_layout:add(separator)
	right_layout:add(bat)
	right_layout:add(separator)
	right_layout:add(vol)
	--right_layout:add(separator)
	--right_layout:add(bright)
	right_layout:add(separator)
...
globalkeys = awful.util.table.join(
   ...
   --awful.key({                    }, "XF86TouchpadToggle", function() touchpad_state = toggle_touchpad(touchpad_state)end),
