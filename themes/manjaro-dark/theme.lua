...
theme = {}
theme.dir = os.getenv("HOME") .. "/.config/awesome/themes/manjaro-dark"
...
naughty.config.presets.normal.bg = "#2d2d2d"
naughty.config.presets.normal.fg = "#cccccc"
...
theme.bg_urgent     = "#2388C8"
theme.bg_minimize   = "#000000"
theme.bg_systray    = "#202020"

theme.separator     = "#285577"
theme.widgettext    = "#9ababa"
